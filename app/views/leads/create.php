...
<div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
    <div class="px-8 py-6 border-b border-gray-100 bg-gray-50/50">
        ...
        <p class="text-gray-500 text-sm mt-1">Add a potential opportunity to your list.</p>
    </div>
    ...
    <div class="p-8">
        ...
        <form action="<?= BASE_URL ?>/lead/create" method="POST" class="space-y-6">
            <input type="hidden" name="csrf_token" value="<?php echo \App\Core\Validator::generateCsrf(); ?>">

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Lead Name <span
