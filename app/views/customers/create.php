...
<div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
    <div class="px-8 py-6 border-b border-gray-100 bg-gray-50/50">
        ...
        <p class="text-gray-500 text-sm mt-1">Enter the details of the new customer below.</p>
    </div>
    ...
    <div class="p-8">
        ...
        <form action="<?= BASE_URL ?>/customer/create" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="company" value="<?php echo htmlspecialchars($old['company'] ?? ''); ?>"
                        class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition outline-none">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" pattern="^9\d{9}$" title="Must be 10 digits and start with 9"
                        value="<?php echo htmlspecialchars($old['phone'] ?? ''); ?>"
                        class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition outline-none">
                    <p class="text-xs text-gray-500 mt-1">Format: 10 digits starting with 9</p>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="address" rows="3"
                    class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition outline-none"><?php echo htmlspecialchars($old['address'] ?? ''); ?></textarea>
            </div>
