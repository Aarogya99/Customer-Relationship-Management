...
<div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
    <div class="px-8 py-6 border-b border-gray-100 bg-gray-50/50">
        ...
        <p class="text-gray-500 text-sm mt-1">Update customer details below.</p>
    </div>
    ...
    <div class="p-8">
        ...
        <form action="<?= BASE_URL ?>/customer/update" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="address" rows="3"
                    class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition outline-none"><?php echo htmlspecialchars($customer['address'] ?? ''); ?></textarea>
            </div>
